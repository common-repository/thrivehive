...
// Whether this WordPress instance is using the ThriveHive WYSIWYG theme
// Helps differentiate behavior and maintain backwards compatibility
function is_thrivehive_wysiwyg() {
	$current_theme_object = wp_get_theme();
	return ($current_theme_object->get('Name') === TH_WYSIWYG_THEME_NAME);
}
?>
