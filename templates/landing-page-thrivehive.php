    ...
    */
    ...
    if( $landing_form_id !== false || $landing_form_id == 0 && $tracker_id !== false) {
        if ($id = get_option("th_default_landingform_id")) {
            ...
            $form = get_default_form_by_type('landing');
            if ($form != null) {
                echo $form['html'];
            } else {
                ?>
                ...
                <form class="hiveform" action="https://<?php echo $env; ?>/Webform/FormHandler" method="post"
                      id="thrivehive-form278">
                    <label for="input5-form278">First Name<span class="required-star">*</span></label><input type="text"
                                                                                                             name="list.first_name"
                                                                                                             id="input5-form278"/>
                    <div id="input5-form278-errors" class="error-block"></div>
                    <label for="input6-form278">Last Name</label><input type="text" name="list.last_name"
                                                                        id="input6-form278"/>
                    ...
                    <label for="input8-form278">Email<span class="required-star">*</span></label><input type="text"
                                                                                                        name="list.email"
                                                                                                        id="input8-form278"/>
                    <div id="input8-form278-errors" class="error-block"></div>
                    <label for="input14-form278">Comments</label><textarea type="text" name="list.comments"
                                                                           id="input14-form278"></textarea>

                    <div id="input14-form278-errors" class="error-block"></div>

                    <input type="hidden" name="meta.redirectUrl" id="meta_redirectUrl"
